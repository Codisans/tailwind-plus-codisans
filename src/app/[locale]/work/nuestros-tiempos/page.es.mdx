...
| 4. Resumen | [Transformers.js](https://huggingface.co/docs/transformers.js/en/index) | Generar resúmenes legibles por humanos para cada clúster, directamente en el navegador del usuario. |
