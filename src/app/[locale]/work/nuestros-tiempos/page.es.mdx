...
export const caseStudy = {
  ...
  title: 'Nuestros Tiempos — Navegando la Complejidad de las Noticias en Chile con IA',
  description:
...
Desarrollada por Codisans, explora cómo el aprendizaje no supervisado y los embeddings vectoriales pueden descubrir patrones entre miles de artículos periodísticos — de forma automática, sin supervisión humana y ejecutándose en un servidor que cuesta apenas $4 al mes.
...
- Ejecutar todo el sistema en un VPS pequeño por menos de $4 al mes.
...
|-------|---------|-----------|
| 1. Embeddings | [Model2Vec](https://minish.ai/packages/model2vec/introduction) (embeddings estáticos) | Generar representaciones semánticas de los artículos. |
| 2. Reducción de Dimensionalidad | [UMAP](https://umap-learn.readthedocs.io/en/latest/) | Comprimir los embeddings preservando su estructura. |
| 3. Agrupamiento (Clustering) | [HDBSCAN](https://hdbscan.readthedocs.io/en/latest/how_hdbscan_works.html) | Detectar grupos densos que representen narrativas temáticas. |
...
2. **Vectorización** – Cada artículo se convierte en un vector de 768 dimensiones utilizando un modelo estático derivado de EmbeddingGemma de Google DeepMind mediante Model2Vec.
...
- Desplegado en un VPS pequeño con un costo de $4/mes  
...
- Mejores embeddings usando Sentence-transformers para embeddings contextuales
