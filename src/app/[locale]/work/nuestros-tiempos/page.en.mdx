...
export const caseStudy = {
  client: 'Codisans',
  title: "Case Study: Nuestros Tiempos — Decoding Chile's News Complexity with AI",
  description:
...
This project exemplifies Codisans' ability to turn advanced AI concepts into real-world, efficient, and production-ready systems.
...
| 4. Summarization (Planned) | transformers.js | Generate human-readable summaries of each cluster. |
...
- **transformers.js** (upcoming): integrates client-side summarization for explainable AI.
...
2. **Vectorization** – Each article is converted into a 768-dimensional vector using a static model distilled from Google's EmbeddingGemma with Model2vec.
