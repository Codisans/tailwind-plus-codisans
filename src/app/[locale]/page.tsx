...
const workCards = [
  {
    ...
    title: 'Keai',
    description:
      'We built a bespoke web application for Keai, a startup that helps people find the best activities in their city.',
    link: 'https://keai.cl',
    date: '2025-01-01',
    type: 'Case study',
  },
  {
    ...
    title: "DCV'87",
    description:
      "We helped DCV'87 create a creative e-commerce platform, helping drive sales and increase customer engagement.",
    link: 'https://dcv87.com',
    date: '2025-01-01',
    type: 'Case study',
  },
  {
    ...
    description:
      'We helped Phobia create a new website that is more user-friendly and engaging.',
    link: 'https://latorreambulante.cl',
    date: '2025-01-01',
    type: 'Case study',
  },
]
...
export default async function Home() {
  ...
  return (
    <RootLayout>
      ...
      <ListBlock
        eyebrow="Services"
        title="We specialise in crafting beautiful, high quality marketing pages."
        summary=" As long as those opportunities involve giving us money to re-purpose old projects — we can come up with an endless number of those."
        image={imageLaptop}
        items={dummyList}
      />
      <CardsBlock
        title="Our work"
        summary="We build a variety of web solutions, from simple landing pages to complex web applications."
        cards={workCards}
      />
      {/* <Testimonial
